    ...
    <div className="min-h-screen flex flex-col justify-between bg-white text-gray-800">
      ...
      <main className="flex-grow p-6 max-w-4xl mx-auto">
        ...
        <div className="text-lg space-y-4">
          <p>By using our services, you agree to our terms and conditions. All projects require written approval and may be subject to weather-related delays. Quotes are valid for 30 days. For full terms, please contact us.</p>
        </div>
      </main>
