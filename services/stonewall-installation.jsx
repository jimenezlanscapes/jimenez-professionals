  ...
  return (
    <div className="bg-[#f0f8f0] min-h-screen text-[#3e4c35] font-sans">
      <header className="flex justify-between items-center px-8 py-6">
        ...
        <img src="/assets/stonewall-installation/IMG_20250616_133509.jpg" alt="IMG_20250616_133509.jpg" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/stonewall-installation/IMG_20250616_133546.jpg" alt="IMG_20250616_133546.jpg" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/stonewall-installation/Screenshot_20250613-151852.png" alt="Screenshot_20250613-151852.png" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/stonewall-installation/Screenshot_20250613-151929.png" alt="Screenshot_20250613-151929.png" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/stonewall-installation/Screenshot_20250613-151943.png" alt="Screenshot_20250613-151943.png" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/stonewall-installation/IMG_20250616_133509.jpg" alt="stonewall-installation" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/stonewall-installation/IMG_20250616_133546.jpg" alt="stonewall-installation" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/stonewall-installation/Screenshot_20250613-151852.png" alt="stonewall-installation" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/stonewall-installation/Screenshot_20250613-151929.png" alt="stonewall-installation" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/stonewall-installation/Screenshot_20250613-151943.png" alt="stonewall-installation" style={width: "100%", marginBottom: "1rem"} />
</div>
