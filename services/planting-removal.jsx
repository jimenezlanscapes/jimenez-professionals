  ...
  return (
    <div className="bg-[#f0f8f0] min-h-screen text-[#3e4c35] font-sans">
      <header className="flex justify-between items-center px-8 py-6">
        ...
        <img src="/assets/planting-removal/Screenshot_20250613-151959.png" alt="Screenshot_20250613-151959.png" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/planting-removal/Screenshot_20250613-152202.png" alt="Screenshot_20250613-152202.png" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/planting-removal/Screenshot_20250613-152647.png" alt="Screenshot_20250613-152647.png" style={width: "100%", marginBottom: "1rem"} />
<img src="/assets/planting-removal/Screenshot_20250613-152750.png" alt="Screenshot_20250613-152750.png" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/planting-removal/Screenshot_20250613-151959.png" alt="planting-removal" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/planting-removal/Screenshot_20250613-152202.png" alt="planting-removal" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/planting-removal/Screenshot_20250613-152647.png" alt="planting-removal" style={width: "100%", marginBottom: "1rem"} />
  <img src="/assets/planting-removal/Screenshot_20250613-152750.png" alt="planting-removal" style={width: "100%", marginBottom: "1rem"} />
</div>
