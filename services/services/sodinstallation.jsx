  ...
  return (
    <div className="bg-[#f0f8f0] min-h-screen text-[#3e4c35] font-sans">
      ...
      <main className="px-6 md:px-16 py-8">
        <h1 className="text-3xl md:text-5xl font-bold mb-4">Sod Installation</h1>
        <p className="text-lg mb-6">Professional sod installation to give your lawn a lush, green start—done right the first time.</p>
