...
import Image from 'next/image';
  ...
  <img src="/assets/quarterly-maintenance/69696225_1280200608820931_5992017112120426496_n.jpg" alt="Service Image" className="rounded shadow-md hover:scale-105 transition-transform duration-200" />
  <img src="/assets/quarterly-maintenance/FB_IMG_1749842211625.jpg" alt="Service Image" className="rounded shadow-md hover:scale-105 transition-transform duration-200" />
  <img src="/assets/quarterly-maintenance/FB_IMG_1749842237829.jpg" alt="Service Image" className="rounded shadow-md hover:scale-105 transition-transform duration-200" />
  <img src="/assets/quarterly-maintenance/IMG_20250603_122132.jpg" alt="Service Image" className="rounded shadow-md hover:scale-105 transition-transform duration-200" />
  <img src="/assets/quarterly-maintenance/IMG_20250616_160826.jpg" alt="Service Image" className="rounded shadow-md hover:scale-105 transition-transform duration-200" />
</div>
